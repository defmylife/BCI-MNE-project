    ...
    while True:
        ...
        if timestamps:
            ...
            if time_count == 1.0:
                ...
                # # print(f"predict raw val {predict_raw_value}")
                # # print(f'predict val {predict_value}')
                # print('-----------------------------------------------------------------------------------')
                # print(f'Predict val : 6Hz Left [{predict_raw_value[0][0]*100.0:.2f} %] 10Hz Right [{predict_raw_value[0][1]*100.0:.2f} %] Idle [{predict_raw_value[0][2]*100.0:.2f} %]')
